...
const ContactForm = () => {
  ...
  return (
    ...
    >
      <h1 className="text-cosmic-void text-[24px] sm:text-[28px] xl:text-[32px] leading-[120%] font-helvetica-semibold pb-[20px] sm:pb-[30px] xl:pb-[41px]">
        Talk to our experts
      </h1>

      {submitSuccess && (
        <div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded mb-4">
          <p className="font-helvetica-regular text-[14px] sm:text-[15px]">
      ...
      <div className="flex flex-col gap-[16px] sm:gap-[18px] xl:gap-[22px] text-private-jet">
        ...
        <div>
          <input
            type="email"
            className={`p-[15px] sm:p-[18px] xl:p-[20px] w-full text-[14px] sm:text-[15px] xl:text-[16px] rounded-[10px] border ${
              errors.email ? "border-red-500" : "border-private-jet"
        ...
        <div className="flex flex-col sm:flex-row gap-[16px] sm:gap-[18px]">
          <div className="w-full">
            <input
              type="text"
              className={`p-[15px] sm:p-[18px] xl:p-[20px] w-full text-[14px] sm:text-[15px] xl:text-[16px] rounded-[10px] border ${
                errors.firstName ? "border-red-500" : "border-private-jet"
              } font-helvetica-regular`}
          ...
          <div className="w-full">
            <input
              type="text"
              className={`p-[15px] sm:p-[18px] xl:p-[20px] w-full text-[14px] sm:text-[15px] xl:text-[16px] rounded-[10px] border ${
                errors.lastName ? "border-red-500" : "border-private-jet"
              } font-helvetica-regular`}
        ...
        <div>
          <input
            type="tel"
            className={`p-[15px] sm:p-[18px] xl:p-[20px] w-full text-[14px] sm:text-[15px] xl:text-[16px] rounded-[10px] border ${
              errors.phone ? "border-red-500" : "border-private-jet"
            } font-helvetica-regular`}
        ...
        <div className="flex flex-col sm:flex-row gap-[16px] sm:gap-[18px] w-full">
          <div className="w-full relative">
            <select
              className={`p-[15px] sm:p-[18px] xl:p-[20px] w-full text-[14px] sm:text-[15px] xl:text-[16px] rounded-[10px] border ${
                errors.country ? "border-red-500" : "border-private-jet"
              } font-helvetica-regular bg-white appearance-none`}
            ...
            <div className="absolute inset-y-0 right-5   flex items-center pointer-events-none">
              ...
              >
                <path
                  d="M18 2.0001L16.5 0.600098L9 8.0001L1.5 0.600098L0 2.0001L9 11.0001L18 2.0001Z"
                  fill="#879BB4"
                />
              </svg>
            </div>
          ...
          <div className="w-full relative ">
            <select
              className={`p-[15px] sm:p-[18px] xl:p-[20px] w-full text-[14px] sm:text-[15px]  xl:text-[16px] rounded-[10px] border ${
                errors.region ? "border-red-500" : "border-private-jet"
              } font-helvetica-regular bg-white appearance-none`}
        ...
        <div className="w-full">
          <input
            type="text"
            className={`p-[15px] sm:p-[18px] xl:p-[20px] w-full text-[14px] sm:text-[15px] xl:text-[16px] rounded-[10px] border ${
              errors.facilityName ? "border-red-500" : "border-private-jet"
            } font-helvetica-regular`}
            placeholder="Health Facility Name*"
            {...register("facilityName", {
              required: "Health facility name is required",
            })}
          />
          {errors.facilityName && (
            <p className="text-red-500 text-[12px] mt-1">
        ...
        <div>
          <textarea
            className={`p-[15px] sm:p-[18px] xl:p-[20px] w-full text-[14px] sm:text-[15px] xl:text-[16px] rounded-[10px] border ${
              errors.message ? "border-red-500" : "border-private-jet"
            } font-helvetica-regular`}
            placeholder="Message*"
            rows="6"
        ...
        <div className="flex items-start gap-[10px]">
          <input
            ...
            className={`w-4 sm:w-5 h-4 sm:h-5  cursor-pointer border ${
              errors.agreeToTerms ? "border-red-500" : "border-london-rain"
            } mt-1`}
