    ...
    <main className="min-h-screen">
      ...
      <section>
        <div className=" py-[80px] lg:py-[119px] px-[2vw] md:px-[3vw] lg:px-[5.21vw]  max-w-[1440px] mx-auto">
          ...
          >
            Discover hospital management redefined. Experience seamless
          ...
          <div className="mt-[80px] lg:mt-[147px] px-5 lg:px-[75px]  lg:mb-[119px] space-y-[60px] md:space-y-[80px]">
            ...
            >
              ...
              <div className="flex-1 relative before:absolute before:inset-x-0 before:top-0 before:h-[2px] before:bg-gradient-to-r before:from-london-rain before:to-wizard-white">
                ...
                >
                  Provide key details about your hospital, including
                  departments, staff roles, and operational needs. Our system
                  will tailor the best configuration for you.
                </motion.p>
            ...
            >
              ...
              <div className="flex-1 border-t-2 border-wizard-white">
                ...
                >
                  Seamlessly integrate Kazi Afya with your existing systems. Our
                  experts will guide you through data migration, user training,
            ...
            >
              ...
              <div className="flex-1 border-t-2 border-wizard-white">
                ...
                >
                  Go live with Kazi Afya and experience smooth hospital
                  management. Monitor real-time analytics, automate processes,
                  and enhance patient care from day one.
                </motion.p>
              </div>
            </motion.div>
          </div>
