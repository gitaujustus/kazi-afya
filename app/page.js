...
export default function Home() {
  return (
    <main className="min-h-screen">
        ...
        <div className="mx-auto">
          ...
          <div className="relative text-center">
            <h2 className="text-[50px] sm:text-[60px] md:text-[90px] lg:text-[140px] font-700 leading-[120%]">
              ...
              <span className="block text-[#000000]">Weavers</span>
            </h2>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="px-5 lg:px-[155px] pt-[80px] lg:pt-[129px] pb-[100px] lg:pb-[157px] max-w-[1440px] mx-auto">
          <h2 className="font-500 text-[32px] md:text-[40px] lg:text-[48px] leading-[120%] text-cosmic-void max-w-[900px]">
            Discover hospital management redefined. Experience seamless efficiency at every step
          </h2>

          <div className="mt-[60px] md:mt-[80px] lg:mt-[100px] space-y-[60px] md:space-y-[80px]">
            {/* Step 1 */}
            <div className="flex flex-col md:flex-row gap-6 md:gap-10">
              ...
              <div className="flex-1 relative before:absolute before:inset-x-0 before:top-0 before:h-[2px] before:bg-gradient-to-r before:from-london-rain before:to-wizard-white">
                <div className="mb-3 pt-10 text-[20px] tracking-wider text-blue-leviathan">
                  Step 1
                </div>
                {/* font Helvetica Neue */}
                <h3 className="text-[24px] md:text-[32px] lg:text-[48px] font-500 tracking-[0.15px] text-london-rain font-500 mb-4">
            ...
            <div className="flex flex-col md:flex-row gap-6 md:gap-10 ">
              ...
              <div className="flex-1 border-t-2 border-wizard-white  ">
                <div className="mb-3 text-[20px]  tracking-wider text-blue-leviathan">
                  Step 2
                </div>
                <h3 className="text-[24px] md:text-[32px] lg:text-[48px] font-500 tracking-[0.15px] text-london-rain font-500 mb-4">
