...
//               >
//                 <p className="flex-shrink-0 mt-1">
//                   <TickIcon className="w-[16px] h-[16px] sm:w-auto sm:h-auto " />
//                 </p>
//                 <p className="font-figtree bg text-[14px] sm:text-[16px] font-400 leading-[28px] text-cosmic-void">
//                   {feature}
//                 </p>
//               </div>
//             ))}
...
const Pricing = () => {
  ...
  // Switch to annually button handler
  const handleSwitchToAnnually = () => {
    if (!isToggled) {  // Only switch if not already in annual mode
      setIsFlipping(true);
      setTimeout(() => {
        setIsToggled(true);
        setTimeout(() => {
  ...
  return (
    <main className="px-[16px] sm:px-[32px] md:px-[48px] lg:px-[64px] pt-[100px] md:pt-[120px] lg:pt-[155px] pb-[24px] sm:pb-[32px] md:pb-[48px]">
      ...
      >
        ...
        <div>
          <motion.button
            onClick={handleSwitchToAnnually}
            className="bg-london-rain relative mx-auto w-[160px] md:w-[200px] xl:w-[300px] 2xl:w-[280px] h-[46px] md:h-[54px] 2xl:h-[72px] rounded-[36px] 2xl:rounded-[40px] px-[100px] xl:px-[82px] py-[8px] xl:py-[10px] 2xl:py-[14px] 2xl:my-20 flex items-center justify-center gap-3 xl:gap-[15px] 2xl:gap-[20px] font-helvetica-regular text-white hover:text-white group hover:bg-[#022c61] disabled:bg-[#022c61] transition-all duration-700 ease-in-out cursor-pointer disabled:cursor-not-allowed"
            initial="initial"
            whileHover="hover"
            disabled={isToggled}
